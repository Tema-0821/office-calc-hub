  ...
  return (
    <CalculatorLayout
      ...
      guide={
        <>
          <p>
            연차를 다 못 쓰고 한 해가 지나갔다면, 그냥 사라지는 게 아니라 돈으로 정산받을 수
            있습니다. 계산식은 <strong>1일 통상임금 × 미사용 연차일수</strong>이고, 1일 통상임금은
          ...
          <p>
            <strong>계산 예시</strong>: 월급 300만원, 미사용 연차 5일이라면 시급은 300만원 ÷
            209시간 ≈ 14,354원, 1일 통상임금은 14,354원 × 8 ≈ 114,832원입니다. 연차수당은
            114,832원 × 5일 ≈ 57만 4,162원이 됩니다.
          </p>
          <p>
            <strong>연차수당 청구권의 소멸시효</strong>: 미사용 연차수당을 청구할 수 있는 권리는
            발생일로부터 3년입니다. 3년이 지나면 시효가 소멸되어 청구할 수 없게 되므로, 퇴사하며
            정산받지 못한 연차수당이 있다면 너무 늦기 전에 확인하는 것이 좋습니다.
          </p>
          <p>
            <strong>연차수당은 언제 받나요?</strong> 보통 연차 사용 기간(1년)이 끝난 다음 임금
            지급일에 미사용 연차수당을 정산해서 지급합니다. 재직 중이 아니라 퇴사하는 경우에는
            퇴직일로부터 14일 이내에 다른 금품과 함께 정산되는 것이 일반적입니다.
          </p>
        </>
      }
      faq={[
