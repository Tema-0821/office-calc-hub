  ...
  return (
    <CalculatorLayout
      ...
      guide={
        <>
          <p>
            서류마다 나이가 다르게 느껴진 적이 있다면, 한국에는 나이를 세는 방식이 원래 여러
            가지였기 때문입니다. <strong>만 나이</strong>는 태어난 날을 0살로 시작해서 생일이
            지날 때마다 한 살씩 늘어나는 방식으로, 2023년 6월 28일부터 시행된 &ldquo;만 나이
            통일법&rdquo;에 따라 계약, 행정 서류, 대부분의 법령에서 기본으로 사용됩니다.
          </p>
          <p>
