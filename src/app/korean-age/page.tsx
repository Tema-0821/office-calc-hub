    ...
    <CalculatorLayout
      ...
      guide={
        <>
          ...
          <p>
            <strong>계산 예시</strong>: 2000년 1월 1일생인 사람이 2026년 8월 12일을 기준으로 하면,
            올해 생일(1월 1일)이 이미 지났으므로 만 나이는 2026 − 2000 = 26세입니다. 반대로 생일이
            아직 안 지났다면(예: 1995년 12월 25일생을 8월에 계산) 만 나이는 연도 차이에서 1을 뺀
            30세가 됩니다.
          </p>
          <p>
            <strong>만 나이가 실생활에서 쓰이는 곳</strong>: 정년(보통 만 60세 이상), 국민연금
            수급 개시 연령, 경로우대 적용 연령, 각종 계약서상 나이 표기 등 대부분의 법적·행정적
            기준이 만 나이로 통일되어 있습니다. 반면 술·담배 구매 가능 연령을 정하는 청소년보호법,
            병역법상 입영 연령 등 일부 법령은 여전히 연 나이를 기준으로 삼습니다.
          </p>
        </>
      }
      faq={[
