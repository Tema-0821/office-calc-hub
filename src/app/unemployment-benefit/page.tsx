  ...
  return (
    <CalculatorLayout
      ...
      guide={
        <>
          <p>
            퇴사 후 가장 먼저 궁금해지는 게 실업급여일 텐데, 금액은 소득에 비례해서 무한정
            늘어나지 않습니다. <strong>1일 평균임금 × 60%</strong>로 계산하되, 2026년 기준 1일
            상한액 68,100원과 하한액 66,048원 사이에서 결정됩니다. 하한액은 최저시급의 80%에 1일
