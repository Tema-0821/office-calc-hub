  ...
  return (
    <CalculatorLayout
      ...
      guide={
        <>
          <p>
            급여명세서에 &ldquo;주휴수당&rdquo;이라는 항목이 따로 안 보인다고 못 받고 있는 건
            아닙니다. 월급제라면 이미 포함돼 있을 가능성이 높고, 시급제·일급제라면 직접 계산해
            봐야 압니다. 공식은 <strong>시급 × (주 소정근로시간 ÷ 40) × 8</strong>이며, 주 40시간을
            초과해서 일해도 최대 8시간분까지만 인정됩니다.
          </p>
          <p>
